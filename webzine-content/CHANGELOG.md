...
| **소제목 구분** | accent bar + 전용 타이포 클래스<br>(기본 색상, 일반 자간) | · accent bar에 scaleX 등장 애니메이션 추가<br>· 소제목: 틸색 + 넓은 자간<br>· 중제목: 고딕 extrabold |
| **본문 영역** | 720px 폭 | · 본문 텍스트: 680px 중앙 정렬<br>· 사진 영역: 본문보다 넓게 확장 |
